...
public:
	...
	virtual EVRInitError Activate(vr::TrackedDeviceIndex_t unObjectId) {
		...
		vr::VRProperties()->SetProperty(m_ulPropertyContainer, vr::Prop_StatusDisplayTransform_Matrix34, &l_matrix, sizeof(vr::HmdMatrix34_t), vr::k_unHmdMatrix34PropertyTag);
		...
		vr::VRProperties()->SetStringProperty(m_ulPropertyContainer, vr::Prop_ConnectedWirelessDongle_String, "1E8092840E"); // Changed
		...
		vr::VRProperties()->SetStringProperty(m_ulPropertyContainer, vr::Prop_RegisteredDeviceType_String, (m_bHandSide) ? "htc/vive_controllerLHR-F94B3BD9" : "htc/vive_controllerLHR-F94B3BD8"); // Changed
...
void start_python() {
	...
	if(CreateProcessA(NULL, (LPSTR)str.c_str(), NULL, NULL, TRUE, 0, NULL, NULL, &info, &processInfo))
	{
