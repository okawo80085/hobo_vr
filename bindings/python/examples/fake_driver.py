...
class ShadowMapping(CameraWindow):
    ...
    def __init__(self, **kwargs):
        ...
        self.basic_lightL = self.load_program(
    ...
    def render(self, time, frametime):
        ...
        self.basic_lightL["m_shadow_bias"].write(
        ...
        self.basic_lightR["m_shadow_bias"].write(
            matrix44.multiply(depth_mvp, bias_matrix)
        )
        ...
        self.basic_lightHmd["m_shadow_bias"].write(
            matrix44.multiply(depth_mvp, bias_matrix)
        )
